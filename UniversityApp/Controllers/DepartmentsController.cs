...
namespace UniversityApp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            {
                ExistingDepartments = _context.Departments.Select(d => d.Name.ToLower()).ToList()
            };
...
{
    if (_context.Departments.Any(d => d.Name.ToLower() == model.Name.ToLower()))
    {
        ModelState.AddModelError("Name", "Oops! A department with this name already exists. Try another one!");
        model.ExistingDepartments = _context.Departments.Select(d => d.Name.ToLower()).ToList();
        return View(model);
    }
